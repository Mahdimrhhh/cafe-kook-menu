...
export const mockCategories = [
    { id: 1, name: "قهوه داغ", icon: "☕" },
    { id: 2, name: "نوشیدنی سرد", icon: "🧊" },
    { id: 3, name: "لاته آرت", icon: "🎨" },
    { id: 4, name: "دسر و شیرینی", icon: "🍰" },
    { id: 5, name: "کیک و کلوچه", icon: "🥐" },
    { id: 6, name: "صبحانه گرم", icon: "🍳" },
    { id: 7, name: "ساندویچ", icon: "🥪" },
    { id: 8, name: "سالاد سلامت", icon: "🥗" },
    { id: 9, name: "اسموتی", icon: "🥤" },
    { id: 10, name: "دمنوش", icon: "🍵" },
    { id: 11, name: "پاستا مینی", icon: "🍝" },
    { id: 12, name: "عصرانه دنج", icon: "🌆" }
];
...
const menuCatalog = [
    {
        categoryId: 1,
        items: [
            { name: "اسپرسو سینگل", price: 65000, description: "شات غلیظ و بالغ با کرمای طلایی", ingredients: "دانه عربیکا تازه‌برشت، آب فیلترشده", servingStyle: "فنجان پرسلین ۶۰ میلی‌لیتر، سرو گرم", notes: "مناسب عاشقان طعم خالص قهوه", featured: true },
            ...
            { name: "آمریکانو", price: 72000,image: "./img/IMG_6228.JPG", description: "اسپرسو رقیق‌شده با آب داغ برای طعمی ملایم", ingredients: "اسپرسو دبل، آب فیلترشده", servingStyle: "لیوان ۲۴۰ میلی‌لیتر، سرو داغ", notes: "انتخاب محبوب برای صبح‌های طولانی" },
            { name: "کاپوچینو", price: 88000,image: "./img/IMG_20260622_110349_936.jpg", description: "تعادل ایده‌آل اسپرسو، شیر بخار و فوم", ingredients: "اسپرسو، شیر تازه، فوم شیر", servingStyle: "فنجان ۱۸۰ میلی‌لیتر با لایه فوم یکنواخت", notes: "پودر دارچین اختیاری" },
            { name: "لاته کلاسیک", price: 92000, description: "شیر بخارشده نرم با اسپرسوی تک‌شات", ingredients: "اسپرسو، شیر تازه ۳.۵٪ چربی", servingStyle: "لیوان ۳۰۰ میلی‌لیتر", notes: "قابل سفارش با شیر بادام یا جو", featured: true },
    ...
    },
    {
        categoryId: 2,
        items: [
            { name: "کولد برو", price: 95000, description: "استخراج ۱۸ ساعته در دمای سرد", ingredients: "دانه عربیکا متوسط‌برشت، آب سرد", servingStyle: "لیوان یخ‌دار ۳۵۰ میلی‌لیتر", notes: "طعمی شیرین و کم‌اسیدیته", featured: true },
    ...
    },
    {
        ...
        items: [
            ...
            { name: "لاته آرت ببر", price: 112000, description: "طرح ببر با تکنیک فوم‌دهی پیشرفته", ingredients: "اسپرسو دبل، شیر میکروفوم", servingStyle: "فنجان ۲۰۰ میلی‌لیتر", notes: "محبوب‌ترین طرح بین مهمانان", featured: true },
    ...
    },
    {
        ...
        items: [
            ...
            { name: "تیرامیسو", price: 135000, description: "لایه‌ای ایتالیایی با قهوه و ماسکارپونه", ingredients: "ماسکارپونه، اسپرسو، لیدی‌فینگر", servingStyle: "کاسه ۱۵۰ گرمی", notes: "تزئین با پودر کاکائو", featured: true },
    ...
    },
    {
        ...
        items: [
            ...
            { name: "صبحانه ایرانی", price: 145000, description: "پنیر، گردو، عسل و نان تازه", ingredients: "پنیر محلی، عسل طبیعی، گردو", servingStyle: "سینی چوبی اشتراکی", notes: "چای داغ همراه سرو", featured: true },
...
/** Build flat product list with full model fields */
function buildProducts() {
    const categoryMap = Object.fromEntries(mockCategories.map(c => [c.id, c.name]));
    const products = [];
    let id = 1;
    ...
    menuCatalog.forEach(group => {
        group.items.forEach(item => {
            products.push({
                ...
                category: categoryMap[group.categoryId] || "",
                name: item.name,
                price: item.price,
                image: item.image || "",
...
export const mockProducts = buildProducts();
